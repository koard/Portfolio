...
const projects: ProjectDetail[] = [
  ...
  },
  {
    icon: "📡",
    badge: "Web App",
    title: "OpsPulse DevOps Monitoring",
    period: "2026",
    description:
      "DevOps monitoring platform for Ubuntu, Nginx, and PM2 workloads, with health scoring, telemetry ingest, incident alerts, and safe SRE controls.",
    longDescription:
      "OpsPulse is a DevOps monitoring platform designed around a real university-hosted workload running on Ubuntu with Nginx reverse proxy and PM2-managed services. The system combines a Next.js dashboard with .NET 8 microservices for project registry, telemetry ingestion, incident history, SLO tracking, and dashboard aggregation. A Node.js PM2 agent collects host metrics, process status, and endpoint checks, then reports snapshots back to the platform. The project also explores a safe SRE control plane with allowlisted commands, command confirmation, audit history, Dockerized local development, and a production direction using GCP Compute Engine, Docker Compose, Caddy, and PostgreSQL.",
    role: "Full-Stack Developer",
    status: "Production",
    achievements: [
      "Designed a microservice-based monitoring architecture with Gateway API, Project Registry API, Telemetry API, Alerting Worker, and shared domain policies.",
      "Built a Next.js dashboard for project health, PM2 process status, endpoint checks, host metrics, incidents, SLO views, agents, deployments, and runbooks.",
      "Implemented telemetry and incident workflows for ingesting snapshots, evaluating alert rules, tracking incident state, and surfacing root-cause hints.",
      "Developed a Node.js PM2 agent that reports server telemetry and supports allowlisted operational commands for controlled SRE actions.",
      "Prepared Dockerized local and production deployment paths with PostgreSQL, Docker Compose, Caddy, GCP Compute Engine guidance, backups, and agent runbooks."
    ],
    stack: [
      "Next.js",
      ".NET 8",
  ...
  },
  {
    ...
    status: "Production",
    achievements: [
      "Designed and built an internal HR operations portal for a hotel chain with 5 major properties, transitioning manual paper workflows to digital.",
      "Developed a public-facing career board with search, hotel property filtering, department classification, and job application/resume submission.",
      "Engineered a secure Staff Portal with a Kanban-style candidate pipeline enabling HR to screen, rate, drag-and-drop, and transition applicants from Applied to Offered.",
      "Implemented a robust REST API backend using NestJS and Prisma ORM with SQLite database to handle positions, candidates, and file attachments.",
    ],
    stack: ["Next.js", "NestJS", "Prisma", "PostgreSQL", "SQLite", "TypeScript", "Tailwind CSS", "Framer Motion", "React"],
    color: "orange",
    github: null,
    demo: null,
    screenshots: [
